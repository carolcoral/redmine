		...
		request.onreadystatechange = function() {
			if (this.readyState == 4) {
				if(this.status == 200) {
					...
					// Update history - update the history content inside #history container
					const newHistoryContent = doc.querySelector('#history');
					if(newHistoryContent && newHistoryContent.innerHTML.trim()) {
						let historyContainer = document.querySelector('#history');
						
						if(historyContainer) {
							// Replace all history content inside #history
