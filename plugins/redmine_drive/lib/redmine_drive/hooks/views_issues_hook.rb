...
module RedmineDrive
  module Hooks
    class ViewsIssuesHook < Redmine::Hook::ViewListener
      render_on :view_issues_show_description_bottom, partial: 'issue_drive_files/shared_files'
      render_on :view_issues_form_details_bottom, partial: 'issue_drive_files/shared_files_form'
    end
  end
end
