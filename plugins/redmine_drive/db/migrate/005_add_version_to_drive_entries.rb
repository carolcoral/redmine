...
class AddVersionToDriveEntries < ActiveRecord::Migration[4.2]
  def change
    add_column :drive_entries, :version, :integer, null: false, default: 1, index: true
    add_column :drive_entries, :version_name, :string, index: true
  end
end
